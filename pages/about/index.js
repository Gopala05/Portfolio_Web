    ...
    info: [
      {
        ...
        icons: [<FaHtml5 key="html" />, <FaCss3 key="css" />, <FaJs key="js" />, <FaReact key="react" />, <SiDjango key="django" />],
      },
      {
      ...
      },
      {
        ...
        icons: [<SiCsharp key="csharp" />, <SiBlender key="blender" />, <SiUnity key="unity" />],
      },
      {
        title: "Ethical Hacking",
        icons: [<SiKalilinux key="kalilinux" />, <SiWireshark key="wireshark" />, <SiVmware key="vmware" />],
      },
      {
        title: "IOT",
  ...
  return (
    <div className="h-full bg-primary/30 py-36 text-center xl:text-left overflow-y-auto">
      ...
      <motion.div
        ...
        animate="show"
        exit="hidden"
        className="hidden md:hidden xl:flex absolute bottom-0 -left-[230px]"
      >
        <Avatar />
      </motion.div>
      <div
                ...
                >
                  ...
                  <div className="flex gap-x-4">
                    {item.icons?.map((icon, itemIndex) => {
                      return <div className="text-2xl text-white" key={index}>{icon}</div>;
                    })}
                  </div>
                </div>
              );
